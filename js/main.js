...
var ref = new Firebase("https://twitterdemo.firebaseio.com/");
...
$scope.logOut = function() {
	...
	$scope.tweet = (function() {
		$scope.tweets.$add({text: $scope.newTweet, userId: $scope.userId, likes: 0, time: Firebase.ServerValue.TIMESTAMP});
	}).then = (function() {
		$scope.newTweet = "";
	});
